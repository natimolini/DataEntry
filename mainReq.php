    ...
    <div class="atendimento">
        ...
        <div class="bloco-pequeno">
            ...
            <form action="" class="info-container">
                ...
                <label for="exame" class="tituloInfo">Exame:</label>
                <input type="text" id="exame" name="exame" class="input-info" placeholder="Exame do paciente" required><br>
